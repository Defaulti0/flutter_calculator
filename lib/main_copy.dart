...
//   sendReg2(penniVal, nickeVal, dimesVal, quartVal, onesVal, fiveVal, tensVal,
//       twenVal, extraVal, isExact, sum, cashSalesVal2);
// }

// Future<void> sendReg2(
//     String penniVal,
//     String nickeVal,
//     String dimesVal,
//     String quartVal,
...
//               fiveVal2, tensVal2, twenVal2, extraVal2)
//           .toStringAsFixed(2);
...
//     setState(() {
//       totalAfterCS2 = (double.parse(tCashVal) - double.parse(cleanedCsInput))
//           .toStringAsFixed(2);
//     });
//   }
...
//               tabs: const [
//                 Tab(text: "Register 1", icon: Icon(Icons.one_k)),
//                 Tab(text: "Register 2", icon: Icon(Icons.two_k)),
//                 Tab(text: "Register 1 Log", icon: Icon(Icons.history)),
//                 Tab(text: "Register 2 Log", icon: Icon(Icons.history)),
//               ],
//             ),
...
//                                     } else {
//                                       calcCashSales2(
//                                           total, cashSales2.text.substring(1));
//                                     }
//                                   },
//                                 ),
//                               ),
...
//                                       updateText("0", 17);
//                                     } else {
//                                       updateText(extra2.text.substring(1), 17);
//                                     }
//                                   },
//                                 ),
//                               ),
...
//                             mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//                             children: [
//                               Flexible(child: Text("Total: \$$total2")),
//                               Flexible(
//                                   child: Text(
//                                       "After Cash Sales: \$$totalAfterCS2"))
//                             ],
//                           ),
//                           ElevatedButton(
//                             onPressed: () async {
...
//                                     children: [
//                                       Text(
//                                           'Pennies: \$${oCcy.format(reg2['pennies'])}'),
//                                       Text(
//                                           'Nickels: \$${oCcy.format(reg2['nickels'])}'),
//                                       Text(
//                                           'Dimes: \$${oCcy.format(reg2['dimes'])}'),
//                                       Text(
//                                           'Quarters: \$${oCcy.format(reg2['quarters'])}'),
//                                       Text(
//                                           'Ones: \$${oCcy.format(reg2['ones'])}'),
//                                       Text(
//                                           'Fives: \$${oCcy.format(reg2['fives'])}'),
//                                       Text(
//                                           'Tens: \$${oCcy.format(reg2['tens'])}'),
//                                       Text(
//                                           'Twenties: \$${oCcy.format(reg2['twenties'])}'),
//                                       Text(
//                                           'Extra: \$${oCcy.format(reg2['extra'])}'),
//                                       Text('Status: ${reg2['status']}'),
//                                       Text(
//                                           'Total: \$${reg2['total']?.toStringAsFixed(2)}'),
//                                       Text(
//                                           'Cash Sales: \$${reg2['cashSales']?.toStringAsFixed(2)}'),
//                                     ],
//                                   ),
//                                 ],
//                               );
